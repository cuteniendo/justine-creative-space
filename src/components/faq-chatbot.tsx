...
const FAQS: FaqEntry[] = [
  ...
  {
    keywords: ["certif", "training", "course", "devfest", "digiwork"],
    question: "Any certifications?",
    answer:
      "Several — SEO Specialist Training from ML Digital Marketing Agency, The Aquarian Workshop at CHMSU Talisay, Leadership Training with the Esteemed Alliance of IT Students, plus DigiWork eXP 2025 and DevFest Bacolod (2024 & 2025).",
  },
  {
    keywords: ["portfolio", "project", "previous work", "examples", "sample", "sonarco"],
    question: "Can I see your previous work?",
    answer:
      "Definitely — check out the Previous Works section above for brand identity, web build, editorial layout, social campaign, client work, and video edit samples, including the SONARCO capstone platform.",
  },
  {
  ...
  {
    keywords: ["video", "reel", "edit"],
    question: "Do you do video editing?",
    answer:
      "Yes — check the Video Edits card in Previous Works for a few reels I've either edited or appeared in.",
  },
];
